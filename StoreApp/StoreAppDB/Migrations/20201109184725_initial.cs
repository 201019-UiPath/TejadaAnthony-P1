        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseballBatId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CartItems_BaseballBats_BaseballBatId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InventoryId = table.Column<int>(nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    BaseballBatsId = table.Column<int>(nullable: false),
                    Quantity = table.Column<int>(nullable: false),
                    LocationId = table.Column<int>(nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItems_BaseballBats_BaseballBatId",
                        column: x => x.BaseballBatId,
                        principalTable: "BaseballBats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItems_BaseballBatId",
                table: "CartItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_BaseballBatId",
                table: "OrderItems",
                column: "BaseballBatId");
